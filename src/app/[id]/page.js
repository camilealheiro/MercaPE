...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 className="text-3xl font-bold text-blue-600 mb-8">Quem nós somos?</h2>
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-3">
            <p className="text-gray-700 leading-relaxed">
              O MercaPE é uma iniciativa colaborativa que nasceu do desejo de valorizar os mercados públicos do Recife,
              conectando tradição, cultura e tecnologia. Somos um projeto que acredita no poder da memória coletiva e no
              potencial transformador dos mercados como espaços de encontro, comércio justo e turismo cultural. Nosso
              propósito é revitalizar digitalmente esses espaços centenários, oferecendo soluções práticas e inovadoras
              que aproximem visitantes, comerciantes e a comunidade local. Trabalhamos com histórias, sabores e
              personagens que dão vida aos mercados espalhados por toda a cidade. Acreditamos que inovação é olhar para
              o que é tradicional, respeitando as raízes e usando a tecnologia para fortalecer quem faz a economia local
              girar.
            </p>
          </div>
          <div className="flex justify-center lg:justify-end">
            <div className="text-center">
              <div className="w-20 h-20 bg-blue-600 rounded-lg flex items-center justify-center mb-2">
                <div className="text-white font-bold text-sm">UFRPE</div>
              </div>
