...
export function MarketRankingSection() {
  return (
    <section className="bg-gradient-to-b from-[#0C8BFD] to-[#3154A5] py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="bg-white">
            <CardContent className="p-0">
              ...
              />
              <div className="p-4">
                <h3 className="text-lg font-bold text-[#3154A5] mb-1">2° Lugar</h3>
                <p className="text-[#3154A5] font-semibold">Mercado de São José</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white transform scale-105 shadow-lg">
            <CardContent className="p-0">
              ...
              />
              <div className="p-4">
                <h3 className="text-lg font-bold text-[#3154A5] mb-1">1° Lugar</h3>
                <p className="text-[#3154A5] font-semibold">Mercado da Boa Vista</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white">
            <CardContent className="p-0">
              ...
              />
              <div className="p-4">
                <h3 className="text-lg font-bold text-[#3154A5] mb-1">3° Lugar</h3>
                <p className="text-[#3154A5] font-semibold">Mercado da Encruzilhada</p>
              </div>
            </CardContent>
          </Card>
        </div>
